                            ...
                            <div class= "animated fadeIn" style= "overflow-x:auto;">
                              <table id="konfirmasi" class="table table-condensed table-striped">
                                ...
                                <tbody>
                                  <?php
                                    $no=1;
                                    foreach ($confirm as $dataConfirm) {
                                  ?>
                                  <tr>
                                    <td><?php echo $no++; ?></td>
                                    <td><?php echo $dataConfirm['NoKonfirmasi']?></td>
                                    <td><?php echo $dataConfirm['Persetujuan']?></td>
                                    <td><?php echo $dataConfirm['Keterangan']?></td>
                                    <td><?php echo $dataConfirm['NIP']?></td>
                                    <td><?php echo $dataConfirm['Tanggal']?></td>
                                    <td>
                                    <div class="dt-button btn-group">
                                    <a href="<?php echo base_url();?>Dashboard/ubah_data/<?= $dataConfirm['NoKonfirmasi'];?>" onclick="return confirm('Apakah Yakin Ingin Mengubah Data Ini?')">
                                        <button class="btn btn-sm btn-warning btn-custom-datatable" id="buttonEdit">
                                      ...
                                      <div class="dt-button btn-group">
                                      <a href="<?php echo base_url() ?>Dashboard/hapus_data/<?= $dataConfirm['NoKonfirmasi'];?>" onclick="return confirm('Apakah Yakin Ingin Menghapus Data Ini?')">
                                        <button class="btn btn-sm btn-warning btn-custom-datatable" tabindex="0" 
                                        aria-controls="TabelKunjungan" type="button" id="buttonEdit">
