                                    ...
                                    <div class="content-wrapper">
                                        <section class="content">
                                            <div class="x_content">
                                                ...
                                                <?php foreach($confirm_visit as $dataConfirm){?>
                                                <form method="post" action="<?php echo base_url('Dashboard/update') ?>" id="demo-form2" data-parsley-validate
                                                    ...
                                                    <div class="item form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 ">
                                                            <input type="hidden" name="NoKonfirmasi" value="<?=$dataConfirm->NoKonfirmasi?>"
                                                            class="form-control">

                                                            <input type="text" name="NoKonfirmasi" required value="<?=$dataConfirm->NoKonfirmasi?>" readonly
                                                                class="form-control ">
                                                    ...
                                                    <div class="item form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 ">
                                                            <input type="text" id="Keterangan" name="Keterangan"
                                                                value="<?=$dataConfirm->Keterangan?>" required class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="item form-group">
                                                        <label class="col-form-label col-md-3 col-sm-3 label-align"
                                                        ...
                                                        <div class="col-md-6 col-sm-6 ">
                                                        <input type="text" name="NIP" required value="<?=$dataConfirm->NIP?>" readonly
                                                                class="form-control ">
                                                        </div>
                                                    </div>
                                                    <div class="item form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 "> 
                                                             <input type="text" name="Tanggal" required value="<?=$dataConfirm->Tanggal?>" readonly
                                                                class="form-control ">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="item form-group">
                                                        ...
                                                        <button class="btn btn-primary" type="button" onclick="">Cancel</button>
                                                        <button type="submit" class="btn btn-success" value="" href="">Submit</button>      
                                                        </div>
