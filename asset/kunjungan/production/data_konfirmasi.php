                            ...
                            <div class= "animated fadeIn" style= "overflow-x:auto;">
                              <table id="konfirmasi" class="table table-condensed table-striped">
                                ...
                                <tbody>
                                  ...
                                  $no=1;
                                  $result = $conn->prepare("SELECT * FROM confirm_visit");
                                  $result->execute();
                                  ...
                                  <tr>
                                    ...
                                    <a href="edit_cv.php?id=<?=$row->NoKonfirmasi?>" onclick="return confirm('Apakah Yakin Ingin Mengubah Data Ini?')">
                                        <button href="edit_cv.php"class="btn btn-sm btn-warning btn-custom-datatable" tabindex="0" aria-controls="TabelKunjungan" type="button" id="buttonEdit">
                                      ...
                                      <div class="dt-button btn-group">
                                      <a href="hapus_cv.php?id=<?=$row->NoKonfirmasi?>" onclick="return confirm('Apakah Yakin Ingin Menghapus Data Ini?')">
